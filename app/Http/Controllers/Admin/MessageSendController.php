...
class MessageSendController extends Controller
{
    public function index()
    {
        ...
        return view('admin.layouts.pages.message.index', compact('customers', 'sms_setting'));
    }
    ...
    public function send(Request $request)
    {
        ...
        $seeReportUrl = route('sms-report.index');
    ...
    public function customSms()
    {
        ...
        return view('admin.layouts.pages.message.custom-sms', compact('totalSmsCount', 'sms_setting', 'successfulSms'));
    }
