...
<head>
    ...
    <title>Marco Footwear Cash Memo</title>
    <!-- Font Awesome CDN -->
...
<div class="memo-container">
    <div class="header" style="background: url('{{ asset('backend/assets/images/white-waves.jpg') }}') no-repeat center !important;
        background-size: cover !important;">
    ...
    <div class="info">
        ...
        <div class="date-wrapper">
            <span>তারিখ:</span>
            <div class="date-box">{{ $date->format('d') }}</div>
            <div class="date-box">{{ $date->format('m') }}</div>
            <div class="date-box">{{ $date->format('Y') }}</div>
        </div>
    </div>
