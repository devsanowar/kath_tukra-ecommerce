    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Field of Cost</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('field_of_cost.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line case-input">
                                <input type="text" class="form-control" name="field_of_cost" placeholder="Enter Field Name">
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-info text-white text-uppercase">Save Field</button>
                    </div>
                </form>
            </div>
        </div>
