            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mt-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-uppercase"> SMS Delivery Report ({{ $totalSms }})</h4>
                    </div>
                    <div class="body">

                        <form method="GET" action="" class="row justify-content-center mb-4">
                            <div class="col-md-3">
                                <label for="start_date"><b>শুরুর তারিখ:</b></label>
                                <input type="date" name="start_date" id="start_date" class="form-control" value="{{ request('start_date') }}">
                            </div>
                            <div class="col-md-3">
                                <label for="end_date"><b>শেষ তারিখ:</b></label>
                                <input type="date" name="end_date" id="end_date" class="form-control" value="{{ request('end_date') }}">
                            </div>
                            <div class="col-md-3 d-flex align-items-end">
                                <button type="submit" class="btn btn-primary" style="margin-right: 5px">ফিল্টার</button>
                                <a href="{{ url()->current() }}" class="btn btn-danger">রিসেট</a>
                            </div>
                        </form>
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tr>
                                ...
                                <th>গ্রাহকের নাম</th>
                                <th>ফোন নম্বর</th>
                                <th>ব্যবহৃত এসএমএস</th>
                                <th>প্রেরণের তারিখ</th>
                                <th>প্রেরণের অবস্থা</th>
                                <th>অ্যাকশন</th>
                            </tr>
                            </thead>
                            ...
                            @foreach ($sms_reports as $key=>$sms_report)
                                ...
                                <tr>
                                    <td>{{$key+1 }}</td>
                                    <td>
                                        {{ $sms_report->application?->name ?? 'Custom Number' }}
                                    </td>
                            ...
                            <tfoot>
                            <tr>
                                <td colspan="4" class="text-right"><strong>মোট ব্যবহৃত এসএমএস:</strong></td>
