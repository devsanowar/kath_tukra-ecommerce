        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-uppercase"> Create Cost <span><a href="{{ route('cost.index') }}" class="btn btn-primary right">All Costs</a></span></h4>
                </div>

                <div class="body mx-auto" style="width: 60%;">
                    <form class="form-horizontal" action="{{ route('cost.store') }}"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="flex-grow-1">
                                    <input type="date" id="post_title_id" name="date"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="flex-grow-1">
                                    <input type="text" id="post_title_id" name="branch"
                                ...
                                <div class="flex-grow-1">
                                    <select name="field_of_cost_id" class="form-control show-tick">
                                        ...
                                        @foreach ($fields as $field)
                                            <option value="{{ $field->id }}">{{ $field->field_of_cost }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="flex-grow-1">
                                    <input type="number" id="post_title_id" name="amount"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="flex-grow-1">
                                    <input type="text" id="post_title_id" name="spend_by"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7">
                            <button type="submit"
                                class="btn btn-raised btn-primary m-t-15 waves-effect right">SAVE</button>
                        </div>
